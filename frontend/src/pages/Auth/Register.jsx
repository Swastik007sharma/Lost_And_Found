  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--bg-color)] py-12 px-4 sm:px-6 lg:px-8 animate-fade-in-down">
      <div className="w-full max-w-md bg-[var(--bg-color)] p-8 rounded-xl shadow-lg transform transition-all duration-500 hover:shadow-xl">
        <h2 className="text-3xl font-bold text-center text-[var(--text-color)] mb-6 animate-fade-in-down">Register</h2>

        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="animate-fade-in-left" style={{ animationDelay: '0.1s' }}>
            <label htmlFor="name" className="block text-sm font-medium text-[var(--text-color)]">Name</label>
            <Input
              id="name"
              type="text"
              value={name}
        ...
        <p className="mt-4 text-sm text-center text-[var(--secondary)] animate-fade-in-left" style={{ animationDelay: '0.6s' }}>
          Already have an account?{' '}
          <Link to="/login" className="text-[var(--primary)] hover:text-blue-800 transition-colors duration-200">
            Login here
          </Link>
        </p>
      </div>
